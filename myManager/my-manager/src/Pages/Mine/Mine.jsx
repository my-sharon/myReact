...
import icon from './../../Common/images/default.png' //default是关键字不能用，这里给图片命名为icon
...
class Mine extends Component {
                        ...
                        <div className="form-horizontal">
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-md-2 preview">
                                    <img
                                        src={icon_url.includes("undefined") ? icon : icon_url}
                                        style={{border: 1}}
                                    />
                                    <input
                                        type="file"
                            ...
                            <div className="form-group">
                                <div className="col-md-8">
                                    ...
                                    <Link to="/mine/reset" className="btn btn-success pull-right">修改密码？</Link>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    _onSubmit(){
        ...
        const {icon_url}= this.props.userData;
