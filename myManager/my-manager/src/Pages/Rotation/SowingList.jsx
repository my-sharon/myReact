            ...
            <div className="container-fluid">
                <div className="body advert">
                    <ol className="breadcrumb">
                        ...
                        <li classNameName="active">轮播图列表</li>
                    </ol>
                                ...
                                sowingData.map((sowing,key)=>{
                                    return(
                                        <tr key={key}>
                                            ...
                                            <td><img src={IMG_PRE + sowing.image_url}/></td>
                                            <td><img src={IMG_PRE + sowing.image_small_url}/></td>
                                            ...
                                            <td>
                                                ...
                                                <button onClick={()=>this._remove(sowing._id)} className="btn btn-danger btn-xs">删除</button>
                                            </td>
                                        </tr>
                                    )
                                })
